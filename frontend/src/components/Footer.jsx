...
export default function Footer() {
    ...
    return (
        <div style={{padding: "12px 0px", backgroundColor : "#FFA447", textAlign: 'center', position:'fixed', width: '100%',height : '85px', bottom : '0', left: '0', right: '0', zIndex : '999'}}>
            
            <div className="text-center">
                    <h5>
                        Made with ❤️ by Divyansh Pratap Singh
                    </h5>
            </div> 

            <div className="text-center pt-1">
                <a href="https://www.linkedin.com/in/divyansh-pratap-singh-5338a5272" target="_blank" rel="noreferrer">
